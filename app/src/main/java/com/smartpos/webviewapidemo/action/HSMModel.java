...
import static com.cloudpos.sdk.hsm.impl.HSMDeviceImpl.APP_TAG;
...
import com.smartpos.webviewapidemo.util.ByteConvertStringUtil;
import com.smartpos.webviewapidemo.util.CAController;
import com.smartpos.webviewapidemo.util.MessageUtil;
...
public class HSMModel extends ActionModel {
    ...
    public void injectRootCertificate(Map<String, Object> param, ActionCallback callback) {
        ...
        try {
            ...
            in.read(bufCert);
            Log.e(APP_TAG, "inject certificate：file name :" + "testcase_comm_true.crt" + "  injection alias：" + "testcase_comm_true");
//            byte[] bufcert = generatePublicKeyCertificate(mContext);
