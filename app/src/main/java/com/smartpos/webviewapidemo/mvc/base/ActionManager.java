...
package com.smartpos.webviewapidemo.mvc.base;

import android.content.Context;

import com.smartpos.webviewapidemo.mvc.common.Logger;
import com.smartpos.webviewapidemo.mvc.common.MVCException;
...
public final class ActionManager {
    ...
    public static void initActionContainer(ActionContainer actions,String datas) {
        actions.initActions(datas);
